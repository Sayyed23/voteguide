...
export const RegistrationForm = () => {
  ...
  if (isSuccess) {
    return (
      <div className="glass-card p-12 text-center rounded-3xl border border-brand-teal/30 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-brand-teal/10 rounded-full blur-3xl" />
        <div className="relative z-10 flex flex-col items-center">
          <div className="w-20 h-20 bg-brand-teal text-brand-dark rounded-full flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(79,209,197,0.5)] animate-bounce">
      ...
      <form onSubmit={step === 4 ? handleSubmit : (e) => { e.preventDefault(); nextStep(); }}>
        ...
        {step === 3 && (
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="mb-8">
              <label className="block text-xs font-bold uppercase tracking-widest text-gray-500 mb-2">ID Number</label>
              <input 
              ...
              <p className="text-xs text-gray-500 mt-2 flex items-center gap-1">
                <svg className="w-4 h-4 text-brand-teal" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" /></svg>
